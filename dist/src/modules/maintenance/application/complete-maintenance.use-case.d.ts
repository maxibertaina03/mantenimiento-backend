...
export declare class CompleteMaintenanceUseCase {
    ...
    execute(id: string, input: CompleteMaintenanceInput, actorId: string, tenantId: string | null): Promise<MaintenanceOrder>;
}
