...
const prisma_material_mapper_1 = require("../mappers/prisma-material.mapper");
let PrismaMaterialRepository = class PrismaMaterialRepository {
    ...
    async save(material) {
        const data = prisma_material_mapper_1.PrismaMaterialMapper.toPersistence(material);
    ...
    async findById(id) {
        ...
        return raw ? prisma_material_mapper_1.PrismaMaterialMapper.toDomain(raw) : null;
    }
    ...
    async findAll(tenantId) {
        ...
        return materials.map((raw) => prisma_material_mapper_1.PrismaMaterialMapper.toDomain(raw));
    }
    async delete(id) {
