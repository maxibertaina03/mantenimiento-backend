...
let GetToolUseCase = class GetToolUseCase {
    repository;
    ...
    async execute(id) {
        ...
        if (!tool)
            throw new tool_not_found_exception_1.ToolNotFoundException(id);
        return tool_app_mapper_1.ToolAppMapper.toOutput(tool);
    }
};
exports.GetToolUseCase = GetToolUseCase;
exports.GetToolUseCase = GetToolUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(tool_repository_1.TOOL_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], GetToolUseCase);
//# sourceMappingURL=get-tool.use-case.js.map