...
let ListLoansUseCase = class ListLoansUseCase {
    tools;
    constructor(tools) {
        this.tools = tools;
    }
    async execute(toolId, page = 1, pageSize = 20) {
        return this.tools.listLoans(toolId, (page - 1) * pageSize, pageSize);
    }
};
exports.ListLoansUseCase = ListLoansUseCase;
exports.ListLoansUseCase = ListLoansUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(tool_repository_1.TOOL_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], ListLoansUseCase);
//# sourceMappingURL=list-loans.use-case.js.map