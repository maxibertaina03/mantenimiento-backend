    ...
    const tools = await Promise.all([
        prisma.tool.upsert({
            ...
            create: {
                ...
                status: client_1.ToolStatus.AVAILABLE,
                brand: 'Stanley',
        ...
        prisma.tool.upsert({
            ...
            create: {
                ...
                status: client_1.ToolStatus.ON_LOAN,
                brand: 'Makita',
                model: '9mm',
    ...
    const materials = await Promise.all([
        prisma.material.upsert({
            ...
            create: {
                ...
                unit: client_1.MaterialUnit.LITER,
                stock: 45,
                minStock: 10,
        ...
        prisma.material.upsert({
            ...
            create: {
                ...
                unit: client_1.MaterialUnit.METER,
                stock: 8,
                minStock: 3,
        ...
        prisma.material.upsert({
            ...
            create: {
                ...
                unit: client_1.MaterialUnit.KILOGRAM,
                stock: 22,
                minStock: 5,
                location: 'Almacén - Sección A',
            },
    ...
    const providers = await Promise.all([
        prisma.provider.upsert({
            ...
            create: {
                ...
                serviceType: client_1.ProviderServiceType.MAINTENANCE,
                taxId: '20-30456789-1',
        ...
        prisma.provider.upsert({
            ...
            create: {
                ...
                serviceType: client_1.ProviderServiceType.PARTS,
                taxId: '20-66789012-4',
